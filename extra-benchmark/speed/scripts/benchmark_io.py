#!/usr/bin/env python3
"""Shared fail-closed I/O helpers for the speed benchmark."""
...
def load_protocol(path: str | Path = PROTOCOL_PATH) -> dict[str, Any]:
    ...
    if protocol.get("schema_version") != 2:
        raise RuntimeError("Unsupported speed protocol schema")
    if protocol.get("protocol_status") != "frozen_before_optimized_speed_rerun":
        raise RuntimeError("Speed protocol has an unsupported status")
    return protocol
